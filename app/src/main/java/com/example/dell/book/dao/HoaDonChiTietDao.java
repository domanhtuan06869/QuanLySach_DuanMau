package com.example.dell.book.dao;
...
import com.example.dell.book.database.DatabaseHelper;
import com.example.dell.book.model.HoaDon;
import com.example.dell.book.model.HoaDonChiTiet;
...
public class HoaDonChiTietDao {
    ...
    public  int deleteHoaDonChiTietByID(String maHDCT){
        int result = db.delete(TABLE_NAME, "maHDCT=?", new
                String[]{maHDCT});
        if (result==0)
            return  -1;
        return 1;
