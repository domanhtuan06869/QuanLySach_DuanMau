...
import com.example.dell.book.dao.SachDao;
import com.example.dell.book.model.Sach;
...
public class SachAdapter extends BaseAdapter implements Filterable {
    ...
    public static class ViewHolder {
        ...
        TextView txtTenSach, txtGiaBan, txtSoLuong, txtMasach;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtMasach.setText("Mã sách: " + entry.getMaSach());
        holder.txtSoLuong.setText("Số Lượng: " + entry.getSoLuong());
        holder.txtGiaBan.setText("Giá bán: " + entry.getGiaBan());
